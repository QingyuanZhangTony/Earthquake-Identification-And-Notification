...
def download_stream(date, station_info):
    ...
    print("Reading and loading stream from file.")
    return get_stream(date, station_info)  # Call get_stream function to read and return the stream


def get_stream(date, station_info):
    network, station, _ = station_info
    cur_dir = os.getcwd()
    ...
    if os.path.exists(file_path):
        ...
        print("Stream successfully read.")
        print()
        return stream
    else:
